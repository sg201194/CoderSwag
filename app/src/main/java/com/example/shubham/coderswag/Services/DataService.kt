package com.example.shubham.coderswag.Services

import com.example.shubham.coderswag.Model.Category
import com.example.shubham.coderswag.Model.Product

/**
 * Created by Shubham on 3/30/18.
 */
object DataService {
    ...
    val shirts = listOf(
            ...
            Product("Devslopes Shirt Badge Light Gray", "$20", "shirt02"),
            Product("Devslopes Logo Shirt Red", "$22", "shirt03"),
            Product("Devslopes Hustle", "$22", "shirt04"),
            Product("KicflipStudio", "$18", "shirt05")
    )
}